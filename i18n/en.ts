export const en = {
  ...
  dragImageOrClick: "Drag image here or click to select",
  ...
  adminRegisteredUser: "registered users",
  adminAdmins: "Admins",
  ...
  adminUserDeletedSuccess: "User deleted successfully",
  adminUserName: "Name",
  adminUserEmail: "Email",
  adminUserRole: "Role",
  adminUserPhone: "Phone",
  adminUserRegistrationDate: "Registration Date",
  adminActions: "Actions",
  adminEdit: "Edit",
  adminDelete: "Delete",
  adminNoUsersFound: "No users found to display",
  ...
  adminCategoryCreatedDate: "Created Date",
  adminCategoryTechnology: "Technology",
  adminCategoryFoodBeverage: "Food & Beverage",
  adminCategoryMarketing: "Marketing",
  adminCategoryServices: "Services",
  adminCategoryOther: "Other",
  adminDeleteCategoryConfirmation: "Are you sure you want to delete this category?",
  ...
  adminErrorLoading: "Error loading",
  adminTotalCategories: "Total Categories",
  adminMostUsedCategory: "Most Used Category",
  adminSystemStatus: "System Status",
  adminActiveCategories: "Active categories on platform",
  adminHighestCompanyCount: "Highest number of companies",
  adminAllCategoriesWorking: "All categories are working normally",
  adminNameAr: "Name (Arabic)",
  adminNameEn: "Name (English)",
  adminColor: "Color",
  adminNewImageSelected: "New image selected",
  ...
  adminUpdate: "Update",
  adminNoCategorySelected: "No category selected for editing",
  adminFailedToCreateCategory: "Failed to create category",
  adminFailedToUpdateCategory: "Failed to update category",
  adminCategoryCreatedSuccess: "Category created successfully",
  adminCategoryUpdatedSuccess: "Category updated successfully",
  ...
  adminCompanyRegistrationDate: "Registration Date",
  adminRejected: "Rejected",
  adminUnapprove: "Unapprove",
  adminConfirmApprove: "Confirm Approval",
  adminConfirmApproveDesc: "Are you sure you want to approve",
  adminConfirmDelete: "Confirm Deletion",
  adminConfirmDeleteDesc: "Are you sure you want to delete",
  adminCompanyDeletedSuccess: "Company deleted successfully.",
  adminCompanyDeleteError: "Failed to delete company.",
  adminCity: "City",
  adminCountry: "Country",
  adminOwner: "Owner",
  adminRegistrationDate: "Registration Date",
  adminCompanyDetails: "Company Details",
  adminCompanyDetailsNotFound: "Company details not found",
  adminCompanyInfo: "Company Information",
  adminDescription: "Description",
  adminContactInfo: "Contact Information",
  adminOwnerInfo: "Owner Information",
